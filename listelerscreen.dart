...
class _ListelerScreenState extends State<ListelerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 16),
              _topItem("Listeler", 4), // Pembe olan tek yer burası
              const Spacer(),
      ...
      // 🔽 ALT BAR (PEMBE RENK KALDIRILDI)
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: 0,
        backgroundColor: const Color(0xFF1F1F1F),
        selectedItemColor: Colors.white, // Alt taraftaki pembelik kaldırıldı
  ...
  Widget _topItem(String t, int i, {IconData? icon}) {
    bool isSelected = (i == 4); // Sadece Listeler pembe (0xFFFFB3D9)
  ...
  Widget _grid(List list) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        // 🔥 poster uyumsuzluğu burada çözüldü
