...
import 'listelerscreen.dart'; // Bu dosyayı oluşturmuş olmalısın
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int bottomIndex = 0; // Anasayfa seçili
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 16),
              _topItem("Listeler", 4), // İSTEDİĞİN LİSTELER EKLEMESİ
              const Spacer(),
      ...
      // 🔽 ALT NAVİGASYON BARI (TAMAMLANDI)
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (i) {
          if (i == bottomIndex) return; // Zaten o sayfadaysak bir şey yapma
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder:
                      (_) => KullaniciSayfasi(
                        benimID: widget.benimID,
                        kullaniciID: u["id"], // ⭐ TIKLANAN KULLANICI
                      ),
                ),
              );
            },
